...
class TimeVaryingSpeedEstimator():
    ...
    def get_time_varying_rps_estimate(self):
        ...
        rps_estimates = Parallel(n_jobs=-1)(delayed(process)(self.wave_data[window_start_index:window_start_index + self.window_length, :]) for window_start_index in self.window_start_indices)
