...
fig.add_trace(
    go.Scatter(
        y=toby_inner_speed_estimate, mode="lines", name="Toby inner speed estimate"
    )
)
fig.add_trace(
    go.Scatter(
        y=toby_cage_speed_estimate, mode="lines", name="Toby cage speed estimate"
    )
)
fig.add_trace(
    go.Scatter(
        y=douw_inner_speed_estimate, mode="lines", name="Douw inner speed estimate"
    )
)
fig.add_trace(
    go.Scatter(
        y=douw_cage_speed_estimate, mode="lines", name="Douw cage speed estimate"
    )
)
fig.update_layout(
